...
class Slider_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Slider Widget Meta', 'agency' ), // Name
			array( 'description' => __( 'Create slideshow for home page', 'agency' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
     	 $slider_id = ! empty( $instance['slider_id'] ) ? $instance['slider_id'] : __( '115', 'agency' );
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'slider_id' ); ?>"><?php _e( 'Meta Slider ID', 'agency' ) ?>:
...
class TFS_product_cate extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'AAAA XXX', 'agency' ), // Name
			array( 'description' => __( 'afdsf afs sdfs fsfwsfa', 'agency' ), ) // Args
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'class_custom' ); ?>"><?php echo _e( 'Css Class: ', 'agency' ) ?></label>
