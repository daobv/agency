...
class TFS_product_cate extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Product Home Block', 'agency' ), // Name
			array( 'description' => __( 'Show product of a category on block home page', 'agency' ), ) // Args
		);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php echo _e( 'Title Widget: ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number_post' ); ?>"><?php echo _e( 'Number Post: ', 'agency' ) ?> </label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'categoryID' ); ?>"><?php echo _e( 'Select Category ', 'agency' ) ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'class_custom' ); ?>"><?php echo _e( 'Select Css Class: ', 'agency' ) ?></label>
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'banner1' ); ?>"><?php echo _e( 'Banner 1: ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner1_link' ); ?>"><?php echo _e( 'Banner1 link : ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner2' ); ?>"><?php echo _e( 'Banner 2: ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner2_link' ); ?>"><?php echo _e( 'Banner 2 link : ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner3' ); ?>"><?php echo _e( 'Banner 3 : ', 'agency' ) ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner3_link' ); ?>"><?php echo _e( 'Banner 3 link : ', 'agency' ) ?></label>
